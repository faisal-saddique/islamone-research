...
export function HadithBrowserSkeleton() {
  return (
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {[1, 2, 3].map((i) => (
              <div key={i} className="bg-white rounded-lg p-4 text-center border border-gray-200">
                ...
                <SkeletonWithShimmer className="h-4 w-28 mx-auto" />
              </div>
            ))}
          </div>
        </div>
            ...
            {Array.from({ length: 6 }).map((_, i) => (
              ...
              >
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-6 flex-1">
                    ...
                    <div className="flex-1 space-y-3">
                      ...
                      <div className="flex items-center gap-4">
                        ...
                        <SkeletonWithShimmer className="h-4 w-40" />
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-4">
                    <SkeletonWithShimmer className="h-8 w-32" />
