    ...
    <div className="min-h-screen bg-gradient-to-br from-white via-gray-50 to-primary-subtle">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <div className="bg-white rounded-2xl p-8 border border-gray-200 text-center">
            <div className="inline-flex items-center gap-3 mb-4">
              <SkeletonWithShimmer className="w-12 h-12 rounded-full" />
        ...
        <div className="flex justify-between items-center mb-8">
          ...
          <SkeletonWithShimmer className="h-6 w-32 rounded-full" />
          <SkeletonWithShimmer className="h-10 w-36 rounded-lg" />
        </div>
            ...
            >
              <div className="space-y-6">
                ...
                <div className="space-y-3">
                  ...
                  <SkeletonWithShimmer className="h-8 w-4/5 mx-auto" />
                </div>
